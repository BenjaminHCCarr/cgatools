            ...
            )
    {
        options_.add_options()
            ...
            ("field-names", po::value<string>(&fieldNames_)->default_value(
                 // variant fields
                 "GT,PS,NS,AN,AC,AF,SS,FT,CGA_XR,CGA_ALTCALLS,CGA_FI,GQ,HQ,EHQ,CGA_CEHQ,GL,CGA_CEGL,"
                 "DP,AD,CGA_RDP,CGA_ODP,CGA_OAD,CGA_ORDP,"
                 "CGA_PFAM,CGA_MIRB,CGA_RPT,CGA_SDO,CGA_SOMC,CGA_SOMR,CGA_SOMS,CGA_SOMF,"

                 // single-genome CNV fields
                 "GT,CGA_GP,CGA_NP,CGA_CP,CGA_PS,CGA_CT,CGA_TS,CGA_CL,CGA_LS,CGA_LAFS,CGA_LLAFS,CGA_ULAFS,"

                 // somatic CNV fields
                 "CGA_SCL,CGA_SLS,CGA_LAFP,CGA_LLAFP,CGA_ULAFP,"
