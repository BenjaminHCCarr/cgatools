...
namespace cgatools { namespace command {
          ...
          positionalOptions_()
    {
        ...
        hiddenOptions_.add_options()
            ...
            ("commonhdr-file",
             po::value<std::string>(&commonHeaderFileName_),
             "file with common metadata headers to prepend to output files (for supported commands)");
    ...
    std::string Command::getCommonHeaderFileName() const
    {
        return commonHeaderFileName_;
    }
