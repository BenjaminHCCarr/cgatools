...
namespace cgatools { namespace variants {
    ...
    public:
        ...
        //! Returns the union of allele frequencies for all Calls in this
        //! Allele, joined by ";".
        ...
        //! Returns the union of all varFilters for all calls in this
        //! Allele. If filters are given, PASS is excluded.
